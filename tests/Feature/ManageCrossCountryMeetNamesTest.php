...
class ManageCrossCountryMeetNamesTest extends TestCase
{
    ...
    public function an_admin_can_create_a_meet_name()
    {
        ...
        $this->post('/api/cross-country/meet-names', $attributes);

        $this->assertDatabaseHas('cross_country_meet_names', $attributes);

        $this->get('/cross-country/meet-names')
    ...
    public function a_meet_name_requires_a_name()
    {
        ...
        $this->post('api/cross-country/meet-names', $attributes)->assertSessionHasErrors('name');
    }
    ...
    public function an_athlete_cannot_create_meet_names()
    {
        ...
        $this->post('/api/cross-country/meet-names', $attributes)->assertRedirect('/');
    }
    ...
    public function an_admin_can_view_meet_names()
    {
        ...
        $this->get('/cross-country/meet-names')->assertSee('name');
    }
    ...
    public function an_athlete_cannot_view_meet_names()
    {
        ...
        $this->get('/cross-country/meet-names')->assertRedirect('/');
    }
    ...
    public function an_admin_can_update_a_meet_name()
    {
        ...
        $this->patch('/api/cross-country/meet-names/'.$name->id, [
            'name' => 'New Meet Name'
        ])
            ->assertStatus(200);

        $this->assertDatabaseHas('cross_country_meet_names', [
            'name' => 'New Meet Name',
        ]);
    }
    ...
    public function an_athlete_cannot_update_a_meet_name()
    {
        ...
        $this->assertDatabaseHas('cross_country_meet_names', ['name' => 'Original Meet Name']);
    }
