...
@section('content')
    <div class="flex flex-col w-full">
        ...
        <div class="flex flex-wrap justify-around w-full">
            <div class="flex lg:flex-col w-full lg:w-1/6 flex-wrap justify-around font-semibold lg:content-start">
                ...
                <p class="px-2 py-1 text-blue-700"><a href="/track/season-bests/athletes-season-bests/1200m">3200m Run</a></p>
