            ...
            <section class="my-3 p-4 bg-gray-100 rounded-lg">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-input {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" type="email" name="email" value="{{ old('email') }}" required autofocus>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="form-input {{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" type="password" name="password" {{--value="{{ old('password') }}"--}} required>
                    </div>
