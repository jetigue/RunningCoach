            ...
            <div class="table-header">
                ...
                <div v-if="isCoach" class="flex justify-end items-center">
                    <create-button title="Add a Result">
                        <new-track-time-trial-race-result @created="add"></new-track-time-trial-race-result>
                    </create-button>
                </div>
            </div>
            <div v-if="records">
                <div v-for="(result, index) in items" :key="result.id">
                    <track-time-trial-race-result :data="result" @deleted="remove(index)"></track-time-trial-race-result>
                </div>
            </div>
...
<script>
    ...
    import TrackTimeTrialRaceResult from './TrackTimeTrialRaceResult';
    import CreateButton from '../buttons/CreateButton';
    import NewTrackTimeTrialRaceResult from '../forms/NewTrackTimeTrialRaceResult';

    export default Collection.extend({
        mixins: [authMixin],
        props: ['data'],

        components: { TrackTimeTrialRaceResult, CreateButton, NewTrackTimeTrialRaceResult },
