        ...
        <div class="table-container">
                ...
                <div class="flex justify-between w-full">
                    ...
                    <div v-if="isCoach" class="text-right">
                        <create-button title="Add a Team Result">
                            <new-track-time-trial-race @created="add"></new-track-time-trial-race>
                        </create-button>
                    </div>
                </div>
            </div>
            <div v-if="records">
                <div v-for="(race, index) in items" :key="race.id">
                    <track-time-trial-race :data="race" @deleted="remove(index)"></track-time-trial-race>
                </div>
            </div>
...
<script>
    ...
    import TrackTimeTrialRace from './TrackTimeTrialRace';
    import CreateButton from '../buttons/CreateButton';
    import NewTrackTimeTrialRace from '../forms/NewTrackTimeTrialRace';

    export default Collection.extend({
        mixins: [authMixin],
        props: ['data'],

        components: { TrackTimeTrialRace, CreateButton, NewTrackTimeTrialRace },
