<template>
    <div class="">
        <div v-if="editing" class="p-3 border-b border-gray-100">
            <div class="w-full">
                <form action="api/track/time-trials/id"
                      method="POST"
                      id="editCrossCountryTimeTrial"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-input" name="cross_country_venue_id" v-model="form.cross_country_venue_id"
                                required>
                ...
                <div class="flex flex-col hover:bg-white">
                    <div class="flex justify-between p-2 items-center">
                        <div class="text-black w-full md:w-1/2 lg:w-2/5 font-semibold md:font-normal hover:text-blue-700">
                                <a :href="'/cross-country/time-trials/'+this.data.id">{{ name }}</a>
                            </div>
                            ...
                            <div class="w-1/2 md:w-1/4 text-blue-700 font-medium">
                                <a :href="'/cross-country/time-trials/'+this.data.id">Results</a>
                            </div>
                    ...
                    <div v-if="isExpanded" class="px-2">
                        <div class="flex flex-col pb-4 px-4">
                            ...
                            <p class="text-gray-400 w-full py-1">Venue:
                                <span class="text-smoke-800">
                                    {{ venue }}
                                </span>
                            </p>

                            <p class="text-gray-400 w-full py-1">Timing:
                                <span class="text-smoke-800">
                                    {{ timing }}
                                </span>
                            </p>
    ...
    export default {
        ...
        data() {
            return {
                ...
                path: '/cross-country/time-trials/' +this.id,
        ...
        methods: {
            ...
            update() {
                this.form
                    .patch('/api/cross-country/time-trials/' + this.data.id)
                    .then(data => {
