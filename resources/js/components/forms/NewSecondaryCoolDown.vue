<template>
    <form action="/training-calendar/date/steady-runs" method="POST" id="newSecondaryCoolDownRun"
        @submit.prevent="onSubmit"
        @keydown="form.errors.clear()"
        class="p-4 bg-gray-100">
        <header class="text-2xl text-primary font-thin mb-2">Add a Cool-down</header>
        ...
        onSubmit() {
            this.form
                ...
                .then(data => {
                    ...
                    toast({
                        type: 'success',
                        title: 'Cool Down Added Successfully'
                    });
