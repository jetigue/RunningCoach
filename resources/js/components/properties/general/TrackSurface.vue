<template>
    <div class="">
        <div v-if="editing" class="p-3 border-b border-blue-lighter">
            <div class="w-full">
                <form action="api/track-surfaces/id" method="POST" id="editDayTime" @submit.prevent="update"
...
<script>
    export default {
        ...
        methods: {
            ...
            update() {
                this.form
                    .patch('/api/track-surfaces/' + this.data.id)
                    .then(data => {
            ...
            destroy() {
                axios.delete('api/track-surfaces/' + this.data.id);
