<template>
    <div class="">
        <div v-if="editing" class="p-3 border-b border-blue-lighter">
            <div class="w-full">
                <form action="api/runEfforts/id" method="POST" id="editDayTime" @submit.prevent="update"
...
<script>
    export default {
        ...
        methods: {
            ...
            update() {
                this.form
                    .patch('/api/runEfforts/' + this.data.id)
                    .then(data => {
            ...
            destroy() {
                axios.delete('api/runEfforts/' + this.data.id);
