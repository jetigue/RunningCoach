<template>
    <div class="">
        <div v-if="editing" class="p-3 border-b border-blue-lighter">
            <div class="w-full">
                <form action="api/cross-country/meet-names/id" method="POST" id="editSeason" @submit.prevent="update"
            ...
            <div class="flex flex-col border-b border-blue-lightest hover:bg-white">
                <div class="table-row flex justify-between hover:bg-white">
                    <div class="flex md:w-4/5 flex-wrap">
                        <div class="text-grey-darker w-full font-semibold lg:font-normal" v-text="name">
                        </div>
                    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            update() {
                this.form
                    .patch('/api/cross-country/meet-names/' + this.data.id)
                    .then(data => {
            ...
            destroy() {
                axios.delete('/api/cross-country/meet-names/' + this.data.id);
