<template>
    <div class="">
        <div v-if="editing" class="p-3 border-b border-gray-100">
            <div class="w-full">
                <form action="api/cross-country/events/id" method="POST" id="editEvent" @submit.prevent="update"
...
<script>
    export default {
        ...
        methods: {
            ...
            update() {
                this.form
                    .patch('/api/cross-country/events/' + this.data.slug)
                    .then(data => {
                        ...
                        if (this.name != this.data.name || this.meters != this.data.meters) {
                            ...
                            toast({
                                type: 'success',
                                title: 'Cross Country Event Updated'
                            });
                        }
                    })
            ...
            destroy() {
                axios.delete('/api/cross-country/events/' + this.data.slug);
