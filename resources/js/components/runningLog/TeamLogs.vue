<template>
    <div class="flex flex-col">
        <div class="flex justify-between items-baseline">
            <header class="font-light text-2xl pb-1 text-primary"></header>
        ...
        <div class="table-container">
            <div class="table-header">
                <div class="flex w-11/12 pl-1">
                    ...
                    <div class="w-1/3 lg:w-1/6 lg:text-center">
            ...
            <div v-if="records">
                <div v-for="(teamLog, index) in items" :key="teamLog.id">
                    <team-log :data="teamLog" @deleted="remove(index)"></team-log>
                </div>
            </div>
