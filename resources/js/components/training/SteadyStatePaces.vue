<template>
    <section class="flex flex-wrap">
        <div class="flex-col w-full">
            <header class="text-xl text-primary">
                Steady State Pace
            </header>
                    ...
                    <div class="flex flex-col border-b border-gray-100">
                        <div class="flex flex-col">
                            <div class="flex p-1 items-center hover:bg-gray-100 text-center">
                                ...
                                <div class="w-1/4"><p>{{ lowSSPace400 }}</p></div>
                                <div class="w-1/4 font-semibold"><p>{{ sSPace400 }}</p></div>
                                <div class="w-1/4"><p>{{ highSSPace400 }}</p></div>
                            </div>
                            <div class="flex p-1 items-center hover:bg-gray-100 text-center">
                                <div class="w-1/4"><p>1000m</p></div>
                                <div class="w-1/4"><p>{{ lowSSPace1000 }}</p></div>
                                <div class="w-1/4 font-semibold"><p>{{ sSPace1000 }}</p></div>
                                <div class="w-1/4"><p>{{ highSSPace1000 }}</p></div>
                            </div>
                            <div class="flex p-1 items-center hover:bg-gray-100 text-center">
                                <div class="w-1/4"><p>1 Mile</p></div>
                                <div class="w-1/4"><p>{{ lowSSPace1mile }}</p></div>
                                <div class="w-1/4 font-semibold"><p>{{ sSPace1mile }}</p></div>
                                <div class="w-1/4"><p>{{ highSSPace1mile }}</p></div>
                            </div>
                        </div>
                    </div>
                </div>
