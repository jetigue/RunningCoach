<template>
    <div class="">
        <div v-if="editing" class="p-3 border-b border-blue-lighter">
            <div class="w-full">
                <form action="api/interval-runs/id" method="POST" id="editIntervalRun" @submit.prevent="update"
...
<script>
    export default {
        ...
        methods: {
            ...
            update() {
                this.form
                    .patch('/api/interval-run-types/' + this.data.id)
                    .then(data => {
            ...
            destroy() {
                axios.delete('api/interval-run-types/' + this.data.id);
