                    ...
                    <div class="flex flex-col border-b border-gray-100">
                        <div class="flex flex-col">
                            <div class="flex p-1 items-center hover:bg-gray-100 text-center">
                                ...
                                <div class="w-1/4"><p>{{ lowCVPace400 }}</p></div>
                                <div class="w-1/4 font-semibold"><p>{{ cVPace400 }}</p></div>
                                <div class="w-1/4"><p>{{ highCVPace400 }}</p></div>
                            </div>
                            <div class="flex p-1 items-center hover:bg-gray-100 text-center">
                                <div class="w-1/4"><p>1000m</p></div>
                                <div class="w-1/4"><p>{{ lowCVPace }}</p></div>
                                <div class="w-1/4 font-semibold"><p>{{ cVPace }}</p></div>
                                <div class="w-1/4"><p>{{ highCVPace }}</p></div>
                            </div>
                            <div class="flex p-1 items-center hover:bg-gray-100 text-center">
                                <div class="w-1/4"><p>1 Mile</p></div>
                                <div class="w-1/4"><p>{{ lowCVPace1mile }}</p></div>
                                <div class="w-1/4 font-semibold"><p>{{ cVPace1mile }}</p></div>
                                <div class="w-1/4"><p>{{ highCVPace1mile }}</p></div>
                            </div>
                        </div>
                    </div>
                </div>
